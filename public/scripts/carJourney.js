...
//Residential Details
$("#carResidentialDetails").validate({
  rules: {
    building: {
      required: true,
    },
...
$('.preLoanamt a').click(function () {
  ...
  $('#loanAmt').val(a);
  $('.screen-5 .progress-list ul li .top').width('33.33%');
  return false;
})
